...
def assemble_submission(root: Path) -> Path:
    ...
    file_map = {
        ...
        "analysis/content_generation_prompts.json": "analysis/content_generation_prompts.json",
        "analysis/content_generation_prompts.md": "analysis/content_generation_prompts.md",
        "analysis/media_versions.json": "analysis/media_versions.json",
        "analysis/generation_jobs.json": "analysis/generation_jobs.json",
